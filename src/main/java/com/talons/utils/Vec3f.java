...
public final class Vec3f {
    public static final Codec<Vec3f> CODEC = Codec.FLOAT.listOf().comapFlatMap((p_176767_) -> {
        return Util.fixedSize(p_176767_, 3).map((p_176774_) -> {
            return new Vec3f(p_176774_.get(0), p_176774_.get(1), p_176774_.get(2));
        });
    }, (p_176776_) -> {
    ...
    public Vec3f(float p_122234_, float p_122235_, float p_122236_) {
        this.x = p_122234_;
        this.y = p_122235_;
        this.z = p_122236_;
    }

    public Vec3f(Vector4f p_176765_) {
        this(p_176765_.x(), p_176765_.y(), p_176765_.z());
    }

    public Vec3f(Vec3 p_122238_) {
    ...
    public void clamp(Vec3f p_176771_, Vec3f p_176772_) {
    ...
    public void load(Vec3f p_176769_) {
        this.x = p_176769_.x;
        this.y = p_176769_.y;
        this.z = p_176769_.z;
    }
    ...
    public void add(Vec3f p_122254_) {
        this.x += p_122254_.x;
        this.y += p_122254_.y;
        this.z += p_122254_.z;
    }

    public void sub(Vec3f p_122268_) {
        this.x -= p_122268_.x;
        this.y -= p_122268_.y;
        this.z -= p_122268_.z;
    }

    public float dot(Vec3f p_122277_) {
    ...
    public void cross(Vec3f p_122280_) {
        float f = this.x;
        float f1 = this.y;
        float f2 = this.z;
    ...
    public void lerp(Vec3f p_122256_, float p_122257_) {
